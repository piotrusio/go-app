...
export function PageListEmpty({ searchParams, basePath, emptyTitle = "Brak rekordów", emptyMessage = "Nie ma jeszcze żadnych rekordów w bazie danych.", noResultsTitle = "Brak wyników", noResultsMessage = "Nie znaleziono rekordów spełniających podane kryteria wyszukiwania." }) {
    ...
    <div className="text-center py-12 space-y-4">
      ...
      <div className="space-y-2">
        <h3 className="text-lg font-medium text-zinc-900 dark:text-zinc-100">
          {hasFilters ? noResultsTitle : emptyTitle}
        </h3>
